...
extern NSString *const WLRRouterGlobalRouteScheme;
...
/**
 未匹配url回调的block
 */
@property (nonatomic, copy, nullable) void (^unhandledURLHandler)(WLRRouter *routes, NSURL *__nullable URL, NSDictionary<NSString *, id> *__nullable parameters);
/**
 全局router
 */
