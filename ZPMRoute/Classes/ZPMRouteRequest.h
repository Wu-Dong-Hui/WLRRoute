...
typedef void(^ZPMRouteCompletionHandler)(NSError *error,NSDictionary * responseObject);
@interface ZPMRouteRequest : NSObject<NSCopying>
/**
 请求的URL
 */
...
@property(nonatomic,copy)ZPMRouteCompletionHandler targetCallBack;
