...
@interface ZPMRouteRequest()

@end
@implementation ZPMRouteRequest
-(void)setTargetCallBack:(ZPMRouteCompletionHandler)targetCallBack{
    __weak ZPMRouteRequest * weakRequest = self;
...
-(instancetype)initWithURL:(NSURL *)URL{
    ...
    if (self) {
        _URL = URL;
        _queryParameters = [[_URL query] ZPMParametersFromQueryString];
    }
    return self;
}
...
-(id)copyWithZone:(NSZone *)zone{
    ZPMRouteRequest * copyRequest = [[ZPMRouteRequest alloc]initWithURL:self.URL];
